...
export default function ChatPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center p-2 md:p-4 relative">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-sky-900/10 translate-x-1/3 translate-y-1/3 blur-3xl pointer-events-none" />
          ...
          {sidebarOpen && (
            <>
              ...
              <motion.div
                ...
                className="md:hidden absolute left-0 top-0 bottom-0 w-72 z-30 bg-sky-400/60 backdrop-blur-2xl border-r border-white/20 flex flex-col"
              >
        ...
        <div className="flex-1 flex flex-col min-w-0 relative">
          ...
          <div className="md:hidden flex items-center gap-3 glass border-b border-white/20 px-4 py-3 flex-shrink-0">
            <button
              ...
              className="text-sky-700 hover:bg-sky-200 p-2 rounded-xl transition-all"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
              </svg>
            </button>
            <span className="font-bold text-sky-700">💬 QuickChat</span>
          </div>
