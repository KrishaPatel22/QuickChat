...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-sky-900/20 translate-x-1/3 translate-y-1/3 blur-3xl" />
      ...
      >
        ...
        <motion.div
          ...
          className="text-6xl mb-4 bg-gradient-to-br from-sky-700 via-sky-500 to-white bg-clip-text text-transparent drop-shadow-lg"
        >
          🗪 
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl font-bold text-sky-700 mb-3 drop-shadow"
        >
          Quick<span className="text-sky-500">CHAT</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-sky-700 text-lg mb-10 max-w-xl mx-auto"
        >
        ...
        >
          ...
          <Link to="/login">
            <button className="px-8 py-4 rounded-2xl font-semibold text-sky-600 border border-sky-600 hover:bg-white/20 transition-all duration-200 text-lg cursor-pointer">
              Sign In
            </button>
          </Link>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {features.map((f, i) => (
            ...
            >
              ...
              <div className="font-bold text-sky-600 text-sm">{f.title}</div>
              <div className="text-sky-700 text-xs mt-1">{f.desc}</div>
            </motion.div>
          ))}
        </div>
      </motion.div>
